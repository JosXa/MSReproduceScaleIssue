...
namespace ConsoleApp1
{
    public static class Utilities
    {
         ...
         */
        public static void Print(Microsoft.Azure.Management.ContainerService.Fluent.IContainerService containerService)
        {
            StringBuilder info = new StringBuilder();
            ...
            if (containerService.OrchestratorType == Microsoft.Azure.Management.ContainerService.Fluent.Models.ContainerServiceOrchestratorTypes.Kubernetes)
            {
         ...
         */
        public static void Print(Microsoft.Azure.Management.ContainerService.Fluent.IKubernetesCluster kubernetesCluster)
        {
            StringBuilder info = new StringBuilder();
